...
export default class ClassList extends Component {
  ...
  updateFilteredClasses = (
    ...
    console.log("Insier Filtered Classes", selectedDate);
    this.setState({ isLoading: true });
    this.setState({ noClasses: true });
    let classType = "kickstart";
    ...
    if (classSessions.length) {
      ...
      classSessions.forEach((element, index, arr) => {
        ...
        let classTimingDiff = moment(element.dtl_date).diff(moment());
      ...
      // console.log("Filterd Class Length", filteredClassList.length);
  ...
  componentDidMount() {
    ...
    this.askhGetClassList().then((result) => {
      ...
      if (classSessions.length) {
        let filteredClassList = [];
        this.updateFilteredClasses("", classSessions);
      }
    });
  }
  returnScreenNumber = () => {
  ...
  render() {
    ...
    return (
      <div className="row classListScreen">
        {this.props.wlGuestInfo && !this.props.wlGuestInfo.is_customer_new && (
                      ...
                      <div className="row">
                        <div className="col-7">
                          ...
                          <span className="classInstructor">
                            {`(with ${item.a_staff.s_name.trim()} ${item.a_staff.s_family
                              .trim()
                              .concat("", ")")}`}
                          </span>
                        </div>
          ...
          <div className="row navigationButtons">
            <div className="col-12">
              <button
                ...
                onClick={() => {
                  this.props.updateScreen(this.returnScreenNumber());
                }}
              >
                Back
              </button>
