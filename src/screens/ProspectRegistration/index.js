...
//import CountDown from "../CountdownTicker";
export default class ProspectRegistration extends Component {
  ...
  async searchClient(email, k_business) {
    ...
    if (data.is_use) {
      ...
      const loginTypeObj = this.props.loginTypes.find(
        (o) => o.k_login_type === userData.k_login_type
      );
      console.log("obj", loginTypeObj);
      if (loginTypeObj) {
        clientData.is_member = loginTypeObj.is_member;
      }
  ...
  handleSubmit = (values) => {
    ...
    let zapierData = {
      ...
      email: values.email,
      phone: values.phone,
      isPromotional: values.isPromotional,
  ...
  render() {
    ...
    if (
      ...
      /*   buttonLabel =
        "CLAIM YOUR " +
        this.props.wpLocationData.as_franchiseFirstClassOffers[0].label +
        " TRIAL Book NOW →"; */
    }
    if (window.cyberMondayDeal) {
      buttonLabel = "CLAIM YOUR CYBER MONDAY DEAL!";
    }
    if (!this.props.businessID && this.props.isNlpFreeIntro) {
      buttonLabel = "SELECT YOUR LOCATION BELOW";
    }
        ...
        <div className="col-12">
          ...
          <Formik
            initialValues={{
              ...
              isPromotional: clientData.isPromotional || "",
            }}
            onSubmit={(values) => {
                    ...
                    <div className="nearestLocation">
                      ...
                      {!this.props.businessID &&
                        this.props.geoLocationPermission && (
                          <span>Finding your closest location...</span>
                        )}
                      {!this.props.geoLocationPermission && (
